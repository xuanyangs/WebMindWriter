...
启动本地 Cloud HTTP server 并运行 smoke check：

```bash
npm run agent:cloud:http:server:check
```

运行本地 Cloud HTTP auth middleware smoke check：

```bash
npm run agent:cloud:http:auth:check
```

运行本地 Cloud HTTP IdeaAgent route smoke check：
...
运行本地 Cloud HTTP ProjectAgent route smoke check：

```bash
npm run agent:cloud:http:projects:check
```

运行本地 Cloud HTTP WritingAgent route smoke check：

```bash
npm run agent:cloud:http:writing:check
```

运行本地 Cloud HTTP request validation 和 project ownership smoke check：
```bash
npm run agent:cloud:http:validation:check
```

运行本地 Cloud HTTP Project detail route smoke check：
```bash
npm run agent:cloud:http:project-detail:check
```

运行本地 Cloud HTTP Project chapter read route smoke check：
```bash
npm run agent:cloud:http:project-chapter:check
```

运行本地 Cloud HTTP Project chapter save route smoke check：
```bash
npm run agent:cloud:http:project-chapter-save:check
```

运行本地 Cloud HTTP Project chapter revisions route smoke check：
```bash
...
运行本地 Cloud HTTP Project chapter revision restore route smoke check：
```bash
npm run agent:cloud:http:project-chapter-revision-restore:check
```
...
npm run agent:run -- --goal cloud-http-projects
npm run agent:run -- --goal cloud-http-writing
npm run agent:run -- --goal cloud-http-validation
npm run agent:run -- --goal cloud-http-project-detail
...
npm run agent:run -- --goal cloud-http-project-chapter-revision-restore
```
...
reports/latest-cloud-http-projects.md
reports/latest-cloud-http-writing.md
reports/latest-cloud-http-validation.md
reports/latest-cloud-http-project-detail.md
...
cloud/http-projects-smoke.json
cloud/http-writing-smoke.json
cloud/http-validation-smoke.json
cloud/http-project-detail-smoke.json
